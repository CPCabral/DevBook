...
// PararDeSeguirUsuario chama a api para parar de seguir o usuario
...
// SeguirUsuario chama a api para parar de seguir o usuario
...
// DeletarUsuario apaga os dados do usuario do banco de dados
